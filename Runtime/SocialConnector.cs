...
{
	public sealed class SocialConnector
	{
		#if UNITY_IPHONE
		...
		#elif UNITY_ANDROID
		private static AndroidJavaObject klass = new AndroidJavaClass ("com.unity3d.player.UnityPlayer");
		private static AndroidJavaObject activity = klass.GetStatic<AndroidJavaObject> ("currentActivity");
		#endif
...
#else
			Debug.LogWarning("[SocialConnector] does not work with editor.");
#endif
		}
	}
}